...
# Adapted from lingbot-va/wan_va/modules/utils.py for OpenWorldLib integration.
import torch
...
def load_transformer(transformer_path, torch_dtype, torch_device):
    model = WanTransformer3DModel.from_pretrained(transformer_path, torch_dtype=torch_dtype)
